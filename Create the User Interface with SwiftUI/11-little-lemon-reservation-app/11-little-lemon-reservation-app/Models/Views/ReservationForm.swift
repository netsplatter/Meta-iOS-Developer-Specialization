...
struct ReservationForm: View {
    ...
    @State private var temporaryReservation: Reservation? = nil
    ...
    var body: some View {
        VStack {
            ...
            .onChange(of: mustChangeReservation) { _ in
                guard temporaryReservation != nil else { return }
...
struct ReservationForm_Previews: PreviewProvider {
    static var previews: some View {
        let sampleRestaurant = RestaurantLocation(city: "Pontiac", state: "IL", number: "815-844-7260")
        let model = Model()
